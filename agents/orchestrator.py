...
class OrchestratorAgent:
    def __init__(self):
        self.api_key = os.getenv("GROQ_API_KEY")       # ✅ Fixed
        self.gemini_key = os.getenv("GEMINI_API_KEY")  # ✅ Separate key for ToolForge
        self.client = Groq(api_key=self.api_key)
        self.model = "llama-3.3-70b-versatile"
        self.memory = MemoryManager()
        self.web_search = WebSearchTool()
        self.code_executor = CodeExecutorTool()
        self.tool_forge = ToolForge(api_key=self.gemini_key)  # ✅ Uses Gemini key
